...
#SBATCH --gres=gpu:8
#SBATCH --job-name=alternating-sanity-check-parameterized-aug-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-0
...
WARMUP=0
EXPT_NAME="alternating-sanity-check-parameterized-aug-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-0"
