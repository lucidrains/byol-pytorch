...
#SBATCH --gres=gpu:1
#SBATCH --job-name=wd_decay-cifar10-pt_epochs-800-ft_epochs-100-warmup-10-wdd_pt-true-wdd_ft-false-wd_start_1e-3-wd_end_1e-7
...
WARMUP_EPOCHS=10
EXPT_NAME="wd_decay-cifar10-pt_epochs-800-ft_epochs-100-warmup-10-wdd_pt-true-wdd_ft-false-wd_start_1e-3-wd_end_1e-7"
...
srun $WORKFOLDER/cluster/weight_decay_decay/cifar_train_finetune_wdd_pt_true_wdd_ft_false-wd_start_1e-3-wd_end_1e-7.sh $EXPT_NAME $TRAIN_EPOCHS $FINETUNING_EPOCHS $WARMUP_EPOCHS $CONFIG
