...
#SBATCH --gres=gpu:8
#SBATCH --job-name=wd_decay-imagenet-pt_epochs-100-ft_epochs-90-warmup-10-wdd_pt-false-wdd_ft-false
...
WARMUP_EPOCHS=10
EXPT_NAME="wd_decay-imagenet-pt_epochs-100-ft_epochs-90-warmup-10-wdd_pt-false-wdd_ft-false"
