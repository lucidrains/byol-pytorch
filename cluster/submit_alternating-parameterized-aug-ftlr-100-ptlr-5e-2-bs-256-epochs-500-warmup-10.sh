...
#SBATCH --gres=gpu:8
#SBATCH --job-name=alternating-parameterized-aug-ftlr-100-ptlr-5e-2-bs-256-epochs-500-warmup-10
...
WARMUP=10
EXPT_NAME="alternating-parameterized-aug-ftlr-100-ptlr-5e-2-bs-256-epochs-500-warmup-10"
