...
#SBATCH --gres=gpu:8
#SBATCH --job-name=imagenet-alternating-ftlr-100-ptlr-5e-2-bs-256-epochs-400-warmup-0
...
WARMUP_EPOCHS=0
EXPT_NAME="imagenet-alternating-ftlr-100-ptlr-5e-2-bs-256-epochs-$TRAIN_EPOCHS-warmup-$WARMUP_EPOCHS"
LEARNAUG_TYPE="default"

echo "TRAIN EPOCHS $TRAIN_EPOCHS"
echo "FINETUNING EPOCHS $FINETUNING_EPOCHS"
echo "EXPT NAME $EXPT_NAME"
echo "WARMUP EPOCHS $WARMUP_EOCHS"
