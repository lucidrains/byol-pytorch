...
#SBATCH --gres=gpu:8
#SBATCH --job-name=alternating-parameterized-aug-nn-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-0
#SBATCH -o /home/ferreira/workspace/experiments/metassl/logs/%x.%N.%A.%a.out
#SBATCH --array=0-10%1
#SBATCH --exclude=dlcgpu24,dlcgpu08

TRAIN_EPOCHS=150
FINETUNING_EPOCHS=150
WARMUP=0
EXPT_NAME="alternating-parameterized-aug-nn-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-0"
