...
#SBATCH --gres=gpu:8
#SBATCH --job-name=alternating-advanced-stats-ftlr-130-ptlr-5e-2-bs-256-epochs-130-warmup-30
#SBATCH -o /home/ferreira/workspace/experiments/metassl/logs/%x.%N.%A.%a.out
#SBATCH --array=0-8%1

TRAIN_EPOCHS=130
FINETUNING_EPOCHS=130
WARMUP=30
EXPT_NAME="alternating-advanced-stats-ftlr-130-ptlr-5e-2-bs-256-epochs-130-warmup-30"
