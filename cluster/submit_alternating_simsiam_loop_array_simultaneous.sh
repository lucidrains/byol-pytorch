...
#SBATCH --gres=gpu:8
#SBATCH --job-name=alternating-advanced-stats-ftlr-100-ptlr-5e-2-bs-256-epochs-200-run2
#SBATCH -o /home/ferreira/workspace/experiments/metassl/logs/%x.%N.%A.%a.out
#SBATCH --array=0-8%1

TRAIN_EPOCHS=200
FINETUNING_EPOCHS=200
EXPT_NAME="alternating-advanced-stats-ftlr-100-ptlr-5e-2-bs-256-epochs-200-run2"
