...
#SBATCH --gres=gpu:8
#SBATCH --job-name=imagenet-alternating-ftlr-130-ptlr-5e-2-bs-256-epochs-150-warmup-10
...
WARMUP_EPOCHS=10
EXPT_NAME="imagenet-alternating-ftlr-130-ptlr-5e-2-bs-256-epochs-$TRAIN_EPOCHS-warmup-$WARMUP_EPOCHS"
