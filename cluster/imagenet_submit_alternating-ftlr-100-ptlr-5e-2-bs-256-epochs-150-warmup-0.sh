...
#SBATCH --gres=gpu:8
#SBATCH --job-name=imagenet-alternating-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-0
...
WARMUP_EPOCHS=0
EXPT_NAME="imagenet_alternating-ftlr-100-ptlr-5e-2-bs-256-epochs-TRAIN_EPOCHS-warmup-$WARMUP_EPOCHS"
