...
#SBATCH --gres=gpu:8
#SBATCH --job-name=alternating-parameterized-aug-nn-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-50
...
WARMUP=50
EXPT_NAME="alternating-parameterized-aug-nn-ftlr-100-ptlr-5e-2-bs-256-epochs-150-warmup-50"
