'''
--- Code taken from https://github.com/akamaster/pytorch_resnet_cifar10/blob/master/resnet.py ---
--- faster but smaller complexity through fewer conv layers and smaller fc layer (for CIFAR10/100) ---
